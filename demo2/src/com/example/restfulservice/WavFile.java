...
public class WavFile
{
	...
	public static WavFile newWavFile(File file, int numChannels, long numFrames, int validBits, long sampleRate, boolean isgsm) throws IOException, WavFileException
	{
		...
		if (isgsm)
		{
			putLE(49, wavFile.buffer, 8, 2); // Compression Code (Uncompressed)
		}
		else
		{
	...
	public static void mainx(String[] args)
	{
		...
		try
		{
			for (String filename : args)
			{
				...
				WavFile writeWavFile = newWavFile(new File("out.wav"), numChannels, numFrames, validBits, sampleRate, false);
			...
			WavFile writeWavFile = newWavFile(new File("out2.wav"), 1, 10, 23, 44100, false);
